...
- **Purchases:** Id, SupplierId, WarehouseId, InvoiceNumber, Date, Notes?, TotalAmount; items contain ProductId, Quantity, PurchasePrice, DiscountAmount, TaxRateId?, Total.
